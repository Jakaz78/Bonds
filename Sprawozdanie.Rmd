...
### Model ARMA na resztach + diagnostyka
...
### Diagnostyka reszt modelu ARMA

```{r , echo=FALSE}
cat("WYKRES I TESTY DLA RESZT MODEL ARMA:")
checkresiduals(model_arimax)
```

### Test Ljunga-Boxa dla reszt ARMA
...
test_results <- data.frame(
  ...
  Statystyka = c(round(jb_test$statistic, 3), round(lb_resid$statistic, 3),
